...
def send_email(report_file):
    ...
    msg['From'] = '2196900073@qq.com'  # 发件人
    msg['To'] = '1047783724@qq.com'  # 收件人
    ...
    try:
        ...
        smtp.login('2196900073@qq.com', 'jpnyandojetxdjgi')  # 用户名和密码
        smtp.sendmail("2196900073@qq.com", "1047783724@qq.com", msg.as_string())  # 发送给另一个邮箱
        logging.info("邮件发送完成！")
